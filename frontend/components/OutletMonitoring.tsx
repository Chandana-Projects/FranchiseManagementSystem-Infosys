...
const RoyaltyCalculatorModal = dynamic(() => import("./RoyaltyCalculatorModal"), { ssr: false });
const VendorScorecardModal = dynamic(() => import("./VendorScorecardModal"), { ssr: false });
const MenuEngineeringMatrix = dynamic(() => import("./MenuEngineeringMatrix"), { ssr: false });
const OutletComparisonModal = dynamic(() => import("./OutletComparisonModal"), { ssr: false });
const WarRoomPresentationMode = dynamic(() => import("./WarRoomPresentationMode"), { ssr: false });
const KeyboardShortcutsModal = dynamic(() => import("./KeyboardShortcutsModal"), { ssr: false });
const ExecutiveExportStudioModal = dynamic(() => import("./ExecutiveExportStudioModal"), { ssr: false });
const MarginSensitivityMatrixModal = dynamic(() => import("./MarginSensitivityMatrixModal"), { ssr: false });
const LiveDemoGuideModal = dynamic(() => import("./LiveDemoGuideModal"), { ssr: false });
const CCTVVisionSentinelModal = dynamic(() => import("./CCTVVisionSentinelModal"), { ssr: false });
const StoreExpansionSimulatorModal = dynamic(() => import("./StoreExpansionSimulatorModal"), { ssr: false });
const CustomerSentimentStudioModal = dynamic(() => import("./CustomerSentimentStudioModal"), { ssr: false });
const RecipeVarianceEngineModal = dynamic(() => import("./RecipeVarianceEngineModal"), { ssr: false });
const RoyaltyEvasionAuditorModal = dynamic(() => import("./RoyaltyEvasionAuditorModal"), { ssr: false });
const AggregatorReconciliationModal = dynamic(() => import("./AggregatorReconciliationModal"), { ssr: false });
const EquipmentMaintenanceModal = dynamic(() => import("./EquipmentMaintenanceModal"), { ssr: false });
const StatutoryComplianceModal = dynamic(() => import("./StatutoryComplianceModal"), { ssr: false });
const SOPKnowledgeBot = dynamic(() => import("./SOPKnowledgeBot"), { ssr: false });
const QRStockScannerModal = dynamic(() => import("./QRStockScannerModal"), { ssr: false });
const SupplierDispatchModal = dynamic(() => import("./SupplierDispatchModal"), { ssr: false });
const DemoTour = dynamic(() => import("./DemoTour"), { ssr: false });
